...
- **Full-Stack Development**: TypeScript, Node.js, Python, React, Next.js, Angular, Vue.js, Ruby, PHP
- **Backend & APIs**: Node.js/Express, Python (FastAPI/Pydantic, Django), Ruby on Rails, Laravel, .NET Core, REST/GraphQL APIs
- **Cloud & DevOps**: AWS (EKS, Lambda, S3, RDS), GCP, Azure, Kubernetes, Docker, Terraform, CI/CD pipelines
...
![MSSQL](https://img.shields.io/badge/MS_SQL-CC2927?style=flat&logo=microsoft-sql-server&logoColor=white)
...
- AI agent workflows for development tasks

## Interests

- AI-assisted development and developer productivity tools
...
Always learning and building. Open to interesting conversations about technology and development.
